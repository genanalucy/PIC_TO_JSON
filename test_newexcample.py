...
class ImageViewerApp:
    def __init__(self, root):
        ...
        # 过滤已生成JSON文件的图片
        self.image_files = [
            img for img in sorted(all_images)
    ...
    def create_image_panel(self):
        ...
        tk.Button(nav_frame, text="提交", width=10, bg='#4CAF50', command=self.submit_data).pack(side=tk.LEFT, padx=5)
    ...
    def update_form(self):
        ...
        self.pos_entries["example_zhuang"].insert(0, example["壮文"])
        self.pos_entries["example_chinese"].delete(0, tk.END)
        self.pos_entries["example_chinese"].insert(0, example["中文"])
    ...
    def add_new_pronunciation(self):
        ...
        self.current_entry_index = 0
        self.current_example_index = 0  # 重置例句索引
        self.update_form()
