...
class ImageViewerApp:
    ...
    def show_empty_message(self):
        ...
        self.img_canvas.create_text(250, 250, text="没有找到任何图片", fill="green")
        self.title_label.config(text="无图片")
    ...
    def initialize_data(self):
        """初始化空数据结构"""
        self.current_data = {
            "image": os.path.basename(self.image_files[self.current_image_index]),
            "pronunciations": [{
                "zhuang_spelling": "",
                "ipa": "",
                "entries": [{
            ...
            if os.path.exists(json_path):
                with open(json_path, 'r', encoding='utf-8') as f:
                    ...
                    if isinstance(loaded_data, list) and len(loaded_data) > 0:
                        self.current_data = loaded_data[0].copy()
                    else:
